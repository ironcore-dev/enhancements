...
QCow2 layers that make up the disk image.
The layers are evaluated in-order. This means that the first qcow2 layer forms the base
and all subsequent qcow2 layers are applied on top.

**Media Type**

`application/vnd.ironcore.disk.qcow2`
